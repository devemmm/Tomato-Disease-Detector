...
import { View, Text, TouchableOpacity, ScrollView, StatusBar, TextInput, StyleSheet, Image } from 'react-native';
import { APP_GREEN_COLOR, HEIGHT, WIDTH, about_us } from '../contansts/constants';
import { BottomSheet } from 'react-native-btr';
import { AntDesign, Entypo, MaterialIcons, FontAwesome, MaterialCommunityIcons} from '@expo/vector-icons';
...
const AccountScreen = ({navigation})=>{
    ...
    const profile_image = 'https://thumbs.dreamstime.com/b/default-avatar-profile-icon-social-media-user-vector-image-icon-default-avatar-profile-icon-social-media-user-vector-image-209162840.jpg'
    return(
        <View style={styles.container}>
            ...
            <View style={styles.header}>
                ...
                <View>
                    ...
                    <View style={{backgroundColor: 'grey', width: 60, alignItems: 'center'}}>
                        <Text style={{fontSize: 16}}>Famer</Text>
                    </View>
                </View>
            </View>
            <View style={styles.menu}>
                <TouchableOpacity style={styles.menu_op} onPress={()=>setProfile(true)}>
                    <MaterialCommunityIcons  name="account-details" style={styles.menu_icon}/>
                    <View>
                ...
                <TouchableOpacity style={styles.menu_op} onPress={()=>setTermPrivacy(true)}>
                ...
                <TouchableOpacity style={styles.logout_card} onPress={()=>navigation.navigate("Signin")}>
                    <View style={styles.logout_btn}>
                        <FontAwesome name="sign-out" style={styles.menu_icon}/>
                        <View>
                            <Text style={{fontSize: 18, color: APP_GREEN_COLOR}}>Logout</Text>
            ...
            <BottomSheet visible={profile}>
                <View style={{ flex: 1, backgroundColor: 'white', paddingTop: Platform.OS === 'ios' ? StatusBarHeight : null }}>
                    <ScrollView>
                        <View style={{ height: 60, flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-start', paddingHorizontal: 15 }}>
                            <TouchableOpacity 
                            ...
                            <Text style={{fontSize: 20, fontWeight: 'bold'}}>Update Your Account</Text>
                        </View>
                        ...
                        <View style={{ marginHorizontal: 15 }}>
                            ...
                            <View style={{alignItems: 'center', marginTop: HEIGHT * .05}}>
                                <TouchableOpacity 
                                    style={{backgroundColor: APP_GREEN_COLOR, width: 80, height: 40, justifyContent: 'center', alignItems: 'center', borderRadius: 10}}
                                    onPress={()=>setProfile(false)}
                                 >
            ...
            <BottomSheet visible={help}>
                <View style={{ flex: 1, backgroundColor: 'white', paddingTop: Platform.OS === 'ios' ? StatusBarHeight : null }}>
                    <ScrollView>
                        ...
                        <View style={{ paddingHorizontal: 15, paddingTop: HEIGHT * .03, paddingBottom: 20, width: '80%' }}>
                            <Text style={{ fontSize: 20, fontWeight: 'bold' }}>Tomato Disease Detector</Text>
                        </View>                                                 
